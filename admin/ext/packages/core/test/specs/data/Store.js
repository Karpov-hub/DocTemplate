topSuite(
  ...
  function () {
    ...
    beforeEach(function () {
      ...
      kevinRaw = {
        name: "Kevin Cassidy",
        email: "kevin.cassidy@sencha.com",
        evilness: -10,
        group: "support",
        old: true,
        age: 70,
    ...
    describe("loading", function () {
      ...
      describe("loading remote data", function () {
        ...
        describe("setting options on the operation", function () {
          var proxySpy, collectionSortSpy;
          ...
          describe("removing", function () {
            ...
            describe("using removeAt", function () {
              ...
              it("should remove a range of records from their groups", function () {
                ...
                expect(store.getGroups().emptyGroups[codes.getGroupKey()]).toBe(
                  codes
                );
    ...
    describe("Reactive grouping", function () {
      ...
      describe("Test state of groups' sort at the time the sort event fires", function () {
        ...
        it("should work changing sorters", function () {
          ...
          expect(
            groups.items[0].getSorters().items[0] === sorters.items[0]
          ).toBe(true);
          expect(
            groups.items[1].getSorters().items[0] === sorters.items[0]
          ).toBe(true);
      ...
      describe("total summaries", function () {
        describe("local summaries", function () {
          ...
          describe("dynamic changes", function () {
            ...
            it("should react to a loadData", function () {
              store.loadData([{ rate: 20 }, { rate: 30 }]);
              var r = store.getSummaryRecord();
